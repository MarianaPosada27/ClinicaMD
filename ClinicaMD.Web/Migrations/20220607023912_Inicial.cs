        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegMed = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicHistories_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicHistories_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicHistories_DoctorId",
                table: "ClinicHistories",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicHistories_Id",
                table: "ClinicHistories",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClinicHistories_PatientId",
                table: "ClinicHistories",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Doctors_RegMed",
                table: "Doctors",
                column: "RegMed",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcedureTypes_Description",
